...
namespace AasxPredefinedConcepts.AssetInterfacesMappingConfiguration
{
    ...
    public class CD_MappingConfiguration
    {
        ...
        [AasConcept(Cd = "https://admin-shell.io/idta/AssetInterfacesMappingConfiguration/1/0/BindingService", Card = AasxPredefinedCardinality.ZeroToOne)]
        public AasClassMapperHintedRelation BindingService = new AasClassMapperHintedRelation();
