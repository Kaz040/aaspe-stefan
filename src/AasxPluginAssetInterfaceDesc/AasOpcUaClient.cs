...
namespace AasxPluginAssetInterfaceDescription
{
    ...
    public class AasOpcUaClient
    {
        ...
        public async Task StartClientAsync()
        {
            ...
            //if BadIdentitytokenInvalid exception is raised at this point during OPCUA connection,
            //modify the new UserIdentity(_userName, _password) to new UserIdentity()
